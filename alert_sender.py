...
def send_alert_email(alerts, health):
    ...
    try:
        ...
        inbox_id = 'your-inbox@example.com'
        ...
        to_email = config.get('alerts', {}).get('email', 'your-email@example.com')
        ...
        subject = f"[ClawBoard] {overall} — {len(filtered)} alert(s)"
        ...
        html += f"""
            ...
            <p style="color: #6b7280; font-size: 12px; margin-top: 20px;">
                ClawBoard Engine · <a href="http://localhost:5000/health" style="color: #3b82f6;">Open Dashboard</a>
            </p>
        </div></body></html>
        """
        ...
        client.inboxes.messages.send(
            ...
            subject=subject,
            html=html,
            text=f"ClawBoard: {overall}. {len(filtered)} alerts. See dashboard: http://localhost:5000/health"
        )
        return True
